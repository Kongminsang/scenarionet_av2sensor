# Description: Convert only trajectories of Argoverse2 sensor dataset to ScenarioNet format
desc = "Build database from Argoverse2 sensor dataset"
...
if __name__ == '__main__':
    ...
    from scenarionet.converter.argoverse2.sensor_dataset_utils import convert_av2_sensor_scenario, get_av2_sensor_scenarios, preprocess_av2_sensor_scenarios
    ...
    scenarios = get_av2_sensor_scenarios(av2_data_directory, args.start_file_index, args.num_files)

    write_to_directory(
        convert_func=convert_av2_sensor_scenario,
        scenarios=scenarios,
        ...
        preprocess=preprocess_av2_sensor_scenarios
    )
